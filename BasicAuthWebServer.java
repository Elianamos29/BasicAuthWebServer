...
public class BasicAuthWebServer {
    ...
    /*
     * This is a static number of max allowed failed requests i set it to 5 for
     * testing purposes
     */
    private static final int MAXREQUESTS = 6;
    /*
     * The two arraylists below are to hold the ip number and number of failed
     * requests in parllel
     */
    ...
    public void processRequest(Socket s) throws Exception {
        ...
        int numRequests = 0;
        /*
         * if the given ipaddress has already had failed requests the value of
         * numRequests will be upated accordingly
         */
        ...
        if (command.equals("GET")) {
            ...
            /*
             * added the parameter to ensure the requests will not be met if client has
             * exceeded number of allowable failed requests
             */
            if ((c != null)
            && (MiniPasswordManager.checkPassword(c.getUsername(), c.getPassword()))
                ...
                try {
                    /*
                     * sets lastLogin to last entry on login log for each client if there is no log
                     * the default is: "First time loging in"
                     */
                ...
                /*
                 * If the client exceeds the number of allowable failed requests they will no
                ...
                System.out.println("waiting..." + x + " seconds \nYou have had " + numRequests
                        + " failed login attempts \nYour ip will be locked after " + MAXREQUESTS
                        + " failed login attempts");
